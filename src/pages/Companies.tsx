                ...
                <div className="relative p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-8">
                  <div className="flex flex-col gap-4 sm:gap-6 lg:flex-row lg:items-center lg:justify-between">
                    <div className="space-y-2 sm:space-y-3">
                      <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.25em] sm:tracking-[0.35em] text-white/70">Companies</p>
                      <h1 className="text-xl sm:text-2xl lg:text-4xl font-bold leading-tight">Company Management</h1>
